...
* [Visually Impaired Access Modpack]({{% relref "/docs/setup/modpack" %}}) - A mod pack that contains this mod and some quality of life mods, made with heart by [@BrailleBennett](https://github.com/BrailleBennett) for the Fabric mod loader.

## Quality of Life Mods

Here are some mods that can improve your game experience.
There are guides about [installing]({{% relref "/docs/setup/basic#install-your-mods" %}}) and [upgrading]({{% relref "/docs/setup/basic#update-the-game-and-mods" %}}) mods.
...
[Camera Controls]({{% relref "/docs/keybindings#camera-controls" %}}), [Mouse Simulation]({{% relref "/docs/keybindings#mouse-simulation" %}}).
...
Once you find a log block, you can use the [POI Marking feature]({{% relref "/docs/features#poi-marking" %}}).
